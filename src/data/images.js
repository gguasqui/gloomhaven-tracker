// Imágenes de monstruos, clases y habilidades (require estático para Metro)
...
// Imágenes sueltas para habilidades
export const POISON_IMG = require("../../assets/status/poison.png");
export const WOUND_IMG = require("../../assets/status/wound.png");
export const PIERCE_IMG = require("../../assets/status/piercing.png");
export const SHIELD_IMG = require("../../assets/skills/shield.png");
...
export const FLYING_IMG = require("../../assets/skills/flying.png");
export const RETALIATE_IMG = require("../../assets/skills/retaliation.png");
export const BLESS_IMG = require("../../assets/status/bless.png");
export const CURSE_IMG = require("../../assets/status/curse.png");
export const PULL_IMG = require("../../assets/skills/pull.png");
export const PUSH_IMG = require("../../assets/skills/push.png");
export const MUDDLE_IMG = require("../../assets/status/muddle.png");

export const SKILL_STATUS_IMGS = {
